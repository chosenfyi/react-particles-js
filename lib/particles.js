    ...
    return function(e) {
        ...
        (function(e, a) {
            ...
            function B(e, t, a, i, r, s, o) {
                ...
                return n(m || e, function(r, n) {
                    m && (n = r, r = e[n]), W(c, n, B(r, t, a, i, n, e, o));
                }), c;
            }
            function $(e) {
                return ke(e) ? jt(e) : {};
            ...
            }(), yt = ht.toString, ft = vt.hasOwnProperty, bt = vt.toString, _t = RegExp("^" + yt.call(ft).replace(et, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), gt = ut ? ot.Buffer : void 0, xt = ot.Symbol, wt = ot.Uint8Array, kt = h(Object.getPrototypeOf, Object), jt = Object.create, Pt = vt.propertyIsEnumerable, Mt = pt.splice, At = Object.getOwnPropertySymbols, Ot = gt ? gt.isBuffer : void 0, zt = h(Object.keys, Object), Ft = oe(ot, "DataView"), Et = oe(ot, "Map"), St = oe(ot, "Promise"), It = oe(ot, "Set"), Ct = oe(ot, "WeakMap"), Lt = oe(Object, "create"), Tt = de(Ft), Rt = de(Et), Dt = de(St), Wt = de(It), qt = de(Ct), Ut = xt ? xt.prototype : void 0, Bt = Ut ? Ut.valueOf : void 0;
        ...
        var s = a(0), o = function() {
            function e(t, a, r, n, s) {
                i(this, e), this.params = t, this.lifetime = t.particles.lifetime, this.library = a, 
                this.setupSize(), this.setupPosition(s), this.setupColor(r), this.setupOpacity(), 
                this.setupAnimation();
            }
            return n(e, [ {
                key: "setupSize",
                ...
                value: function() {
                    ...
                    if (this.params.particles.move.straight) {
                        if (this.vx = i.x, this.vy = i.y, this.params.particles.move.random) {
                            var n = this.getLag();
                            this.vx = this.vx * Math.random() * n, this.vy = this.vy * Math.random() * n;
                        }
                    } else this.vx = i.x + Math.random() - .5, this.vy = i.y + Math.random() - .5;
                ...
                value: function() {
                    ...
                    var s = void 0;
                    s = void 0 != this.opacity_bubble ? this.opacity_bubble : this.opacity, s *= this.getLag();
                    var o = void 0;
                    if (this.color.rgb) {
            ...
            return r(e, [ {
                ...
                value: function() {
                    ...
                    this.params.particles.array.forEach(function(t, s) {
                        if (t.lifetime--, e.params.particles.move.enable) {
                    ...
                    }), this.params.particles.array = this.params.particles.array.filter(function(e) {
                        return e.lifetime;
                    });
                }
            }, {
